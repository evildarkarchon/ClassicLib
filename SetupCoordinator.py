...
class SetupCoordinator:
    ...
    def run_initial_setup(self) -> None:
        ...
        msg_info(
            f"Hello World! | Crash Log Auto Scanner & Setup Integrity Checker | {classic_ver} | {game_name}",
        ...
        game_path: str | None = yaml_settings(
        ...
        msg_success(
            "ALL CLASSIC AND GAME SETTINGS CHECKS HAVE BEEN PERFORMED!",
            target=MessageTarget.CLI_ONLY
        )
        msg_info(
    ...
    def initialize_application(self, is_gui: bool = False, parent: Any = None) -> None:
        ...
        GlobalRegistry.register(
            ...
            "" if not classic_settings(bool, "VR Mode") else "VR"
        )
        ...
        GlobalRegistry.register(
            ...
            yaml_settings(bool, YAML.Main, "CLASSIC_Info.is_prerelease")
        )
